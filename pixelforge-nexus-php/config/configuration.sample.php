...
class Config
{
    ...
    public $sitename = 'PixelForge Nexus';                // Name of your site, can be changed later
    ...
    public $appDir = '';                                  // Base of application without trailing slash (used for cookies), e.g, /pixelforge-nexus
    ...
    public $sessionExpiration = 1800;                     // How many seconds after inactivity should we logout?  1800seconds = 30minutes
